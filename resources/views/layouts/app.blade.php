...
<head>
    ...
    <title>@yield('title') | {{ $setting->name ?? config('app.name', 'Ticketing') }}</title>
...
<body data-kt-name="ticketing" id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true"
                    ...
                    <div id="kt_app_footer" class="app-footer">
                        <div class="app-container container-fluid d-flex flex-column flex-md-row flex-center flex-md-stack py-3">
                            <div class="text-dark order-2 order-md-1">
                                ...
                                <a href="{{ config('app.url', '#') }}" target="_blank" class="text-gray-800 text-hover-primary">{{ config('app.name', 'Halo Coach') }}</a>
                            </div>
                        </div>
                    </div>
                </div>
