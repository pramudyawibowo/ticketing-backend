                ...
                <div class="card-body p-9">
                    <div class="row mb-5">
                        ...
                        <div class="col-xl-9 fv-row">
                            <input type="text" name="name" class="form-control @error('name') is-invalid @enderror " value="{{ old('name') }}" placeholder="System Name" />
                            @error('name')
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-xl-9 fv-row">
                            <div class="input-group mb-5">
                                ...
                                <input type="number" name="register_balance" class="form-control @error('register_balance') is-invalid @enderror " value="{{ old('register_balance') }}" min="0" />
                            </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-xl-9 fv-row">
                            <div class="input-group mb-5">
                                <span class="input-group-text">Rp</span>
                                <input type="number" id="minimum_withdraw" name="minimum_withdraw" class="form-control @error('minimum_withdraw') is-invalid @enderror " value="{{ old('minimum_withdraw') }}" />
                            </div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-8">
                            <div class="image-input image-input-empty" data-kt-image-input="true" style="background-image: url({{ asset('assets/images/blank.png') }})">
                                <div class="image-input-wrapper w-300px h-125px bgi-position-center" style="background-size: 75%; background-image: url({{ asset('admin/media/svg/avatars/blank.svg') }})"></div>
                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="form-text">Allowed file types: png, jpg, jpeg. (Max. 2MB, Ratio 1:1)</div>
                        </div>
                    </div>
                    <div class="row mb-5">
                        <div class="col-xl-3">
